    ...
    <div className="space-y-6">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <p className="text-gray-600">
          Bienvenido al panel de control. Aquí puedes gestionar usuarios, comunidades y monitorear métricas del sistema.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link href="/admin/communities" className="font-medium text-indigo-700 hover:text-indigo-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-500">
                Moderar y administrar comunidades
              </p>
            </div>
          </Link>
